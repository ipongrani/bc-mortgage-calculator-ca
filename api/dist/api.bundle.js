...
/* harmony export */ });
var r = {
    "./src/calculateLoanPrincipal.js": function _src_calculateLoanPrincipalJs(r, e, t) {
      t.r(e), t.d(e, {
      ...
      var u = function u(r, e) {
        ...
        if (!a(r)) return {
          error: "property price is not a valid number"
        };
        if (!a(e)) return {
          error: "down payment is not a valid number"
        };
        if (e > r) return {
        ...
        return {
          loanPrincipal: t,
          downpaymentRate: n,
          downpaymentPercentage: "".concat(u, "%")
        };
      };
    },
    "./src/calculateMortage.js": function _src_calculateMortageJs(r, e, t) {
      t.r(e), t.d(e, {
        "default": function _default() {
          return u;
        }
       ...
       * 
       */
      var u = function u(r, e, t) {
        if (i(r)) return {
          error: "loan amount is not valid or not supplied"
        };
        if (i(e)) return {
          error: "periodic interest is not valid or not supplied"
        };
        if (i(t)) return {
          error: "payment schedule is not valid or not supplied"
        };
        if (!a(r)) return {
          error: "loan amount is not a valid number"
        };
        if (!a(e)) return {
          error: "periodic interest is not a valid number"
        };
        if (!a(t)) return {
          error: "payment schedule is not a valid number"
        };
        var n = e * Math.pow(1 + e, t),
          u = Math.pow(1 + e, t) - 1;
        return o(r * (n / u), 2);
      };
    },
    "./src/calculatePeriodicInterest.js": function _src_calculatePeriodicInterestJs(r, e, t) {
      t.r(e), t.d(e, {
        "default": function _default() {
          return l;
        }
      ...
      var n = t("../utils/dist/utilities.bundle.js"),
        ...
        a = n["default"].isNonNegativeNumber,
        o = n["default"].formatToDecimalPoint,
        u = n["default"].validatePaymentSchedule;
      /** 
       * @preserve
      ...
      var l = function l(r, e) {
        if (i(r)) return {
          error: "annual interest is not valid or not supplied"
        };
        if (i(e)) return {
          error: "payment schedule is not valid or not supplied"
        };
        ...
        var n = o(r / t, 6),
          l = o(100 * n, 2);
        return {
          periodicInterestRate: n,
          formattedPeriodicInterest: "".concat(l, "%")
        };
      };
    },
    "./src/calculateTotalNumberOfPayments.js": function _src_calculateTotalNumberOfPaymentsJs(r, e, t) {
      t.r(e), t.d(e, {
        "default": function _default() {
          return l;
        }
      ...
      var n = t("../utils/dist/utilities.bundle.js"),
        i = n["default"].isEmpty,
        a = n["default"].isNonNegativeNumber,
        o = n["default"].validAmmortizationPeriod,
        u = n["default"].validatePaymentSchedule;
      /** 
       * @preserve
      ...
      var l = function l(r, e) {
        if (i(r)) return {
          error: "ammortization period is not valid or not supplied"
        };
        if (!o(r)) return {
          error: "ammortization period is not valid"
        };
        if (!a(r)) return {
          error: "ammortization period is not a number"
        };
        if (i(e)) return {
          error: "payment schedule is not valid or not supplied"
        };
    ...
    "./src/cmhcPremiumCalculator.js": function _src_cmhcPremiumCalculatorJs(r, e, t) {
      t.r(e), t.d(e, {
        "default": function _default() {
          return u;
        }
      ...
      var u = function u(r, e) {
        if (i(r)) return {
          error: "loan principal is not valid or not supplied"
        };
        if (i(e)) return {
          error: "down payment is not nvalid or not supplied"
        };
        if (!a(r)) return {
          error: "loan principal is not a valid number"
        };
        if (!a(e)) return {
          error: "down payment is not a valid number"
        };
        ...
        var t = function (r) {
            var e = 100 * r;
            return e >= 20 ? 0 : e >= 15 ? .028 : e >= 10 ? .031 : .04;
          }(e),
          n = o(100 * t, 2),
          u = r * t,
          l = r + u;
        return {
          premiumRate: t,
          premiumPercent: "".concat(n, "%"),
          premiumAmount: u,
          principalWithPremium: l
        };
      };
    },
    "../utils/dist/utilities.bundle.js": function _utils_dist_utilitiesBundleJs(r, e, t) {
      t.r(e), t.d(e, {
        "default": function _default() {
          return u;
        }
      ...
      var n = {
          "./src/convertCurrencyToNumber.js": function _src_convertCurrencyToNumberJs(r, e, t) {
            t.r(e), t.d(e, {
              "default": function _default() {
                return n;
              }
            ...
            var n = function n(r) {
              ...
              if ("string" == typeof r) {
                var e = r.replace(/[$,]/g, "");
                if (!isNaN(Number(e)) && Number(e) >= 0) return parseFloat(e);
              }
              return null;
            };
          },
          "./src/convertToNumeric.js": function _src_convertToNumericJs(r, e, t) {
            t.r(e), t.d(e, {
              "default": function _default() {
                return n;
              }
            ...
            var n = function n(r) {
              if ("number" == typeof r && Number.isFinite(r) && r >= 0) return r;
              if ("string" == typeof r) {
                var e = r.replace(/ /g, "");
                if ("" !== e && !isNaN(e) && parseFloat(e) >= 0) return parseFloat(e);
              }
              return null;
            };
          },
          "./src/formatToDecimal.js": function _src_formatToDecimalJs(r, e, t) {
            t.r(e), t.d(e, {
              "default": function _default() {
                return n;
              }
            ...
            var n = function n(r, e) {
              ...
              if (!(Number.isInteger(Number(e)) && e >= 0)) return null;
          ...
          "./src/isEmpty.js": function _src_isEmptyJs(r, e, t) {
            t.r(e), t.d(e, {
              "default": function _default() {
                return n;
              }
          ...
          "./src/isNonNegativeNumber.js": function _src_isNonNegativeNumberJs(r, e, t) {
            t.r(e), t.d(e, {
              "default": function _default() {
                return n;
              }
            ...
            var n = function n(r) {
              return "number" == typeof r && Number.isFinite(r) && r >= 0 && !isNaN(r);
            };
          },
          "./src/validateAmmortizationPeriod.js": function _src_validateAmmortizationPeriodJs(r, e, t) {
            t.r(e), t.d(e, {
              "default": function _default() {
                return n;
              }
          ...
          "./src/validatePaymentSchedule.js": function _src_validatePaymentScheduleJs(r, e, t) {
            ...
            var n = {
              ...
              i = function i(r) {
                return !!Object.keys(n).includes(r) && (n[r] || null);
              };
          }
        },
        i = {};
      function a(r) {
        ...
        return n[r](t, t.exports, a), t.exports;
      }
      a.d = function (r, e) {
        for (var t in e) a.o(e, t) && !a.o(r, t) && Object.defineProperty(r, t, {
          enumerable: !0,
          get: e[t]
        });
      }, a.o = function (r, e) {
      ...
      !function () {
        ...
        var r = a("./src/isNonNegativeNumber.js"),
          e = a("./src/isEmpty.js"),
          t = a("./src/formatToDecimal.js"),
          n = a("./src/validateAmmortizationPeriod.js"),
...
(function () {
  ...
  var r = t("./src/calculateLoanPrincipal.js"),
    e = t("./src/calculatePeriodicInterest.js"),
    i = t("./src/calculateTotalNumberOfPayments.js"),
    a = t("./src/calculateMortage.js"),
    o = t("./src/cmhcPremiumCalculator.js");
  var u = {
    calculateLoanPrincipal: r["default"],
    calculatePeriodicInterest: e["default"],
    calculateTotalNumberOfPayments: i["default"],
    calculateMortage: a["default"],
    cmhcPremiumCalculator: o["default"]
  };
})();
var i = n["default"];
...
/***/ "../utils/dist/utilities.bundle.js":
/*!*****************************************!*\
  !*** ../utils/dist/utilities.bundle.js ***!
  \*****************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
var e = {
    "./src/convertCurrencyToNumber.js": function _src_convertCurrencyToNumberJs(e, r, t) {
      ...
      var n = function n(e) {
        ...
        if ("string" == typeof e) {
          var r = e.replace(/[$,]/g, "");
          if (!isNaN(Number(r)) && Number(r) >= 0) return parseFloat(r);
        }
        return null;
      };
    },
    "./src/convertToNumeric.js": function _src_convertToNumericJs(e, r, t) {
      t.r(r), t.d(r, {
        "default": function _default() {
          return n;
        }
      ...
      var n = function n(e) {
        ...
        if ("string" == typeof e) {
          var r = e.replace(/ /g, "");
          if ("" !== r && !isNaN(r) && parseFloat(r) >= 0) return parseFloat(r);
        }
        return null;
      };
    },
    "./src/formatToDecimal.js": function _src_formatToDecimalJs(e, r, t) {
      t.r(r), t.d(r, {
        "default": function _default() {
          return n;
        }
      ...
      var n = function n(e, r) {
        ...
        if (!(Number.isInteger(Number(r)) && r >= 0)) return null;
        var t = new Intl.NumberFormat("en-US", {
    ...
    "./src/isEmpty.js": function _src_isEmptyJs(e, r, t) {
      t.r(r), t.d(r, {
        "default": function _default() {
          return n;
        }
    ...
    "./src/isNonNegativeNumber.js": function _src_isNonNegativeNumberJs(e, r, t) {
      t.r(r), t.d(r, {
        "default": function _default() {
          return n;
        }
      ...
      var n = function n(e) {
        return "number" == typeof e && Number.isFinite(e) && e >= 0 && !isNaN(e);
      };
    },
    "./src/validateAmmortizationPeriod.js": function _src_validateAmmortizationPeriodJs(e, r, t) {
      t.r(r), t.d(r, {
        "default": function _default() {
          return n;
        }
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   expressApp: () => (/* binding */ expressApp),
/* harmony export */   expressServer: () => (/* binding */ expressServer)
/* harmony export */ });
/* harmony import */ var express__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! express */ "./node_modules/express/index.js");
/* harmony import */ var _core_dist_core_bundle_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../core/dist/core.bundle.js */ "../core/dist/core.bundle.js");
/* harmony import */ var _utils_dist_utilities_bundle_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../utils/dist/utilities.bundle.js */ "../utils/dist/utilities.bundle.js");
...
var __filename = (0,url__WEBPACK_IMPORTED_MODULE_4__.fileURLToPath)("file:///home/a10/nodejs_projects/mortgage_calculator/api/server.js");
var __dirname = path__WEBPACK_IMPORTED_MODULE_3__.dirname(__filename);
var convertCurrencyToNumber = _utils_dist_utilities_bundle_js__WEBPACK_IMPORTED_MODULE_2__["default"].convertCurrencyToNumber,
  convertToNumeric = _utils_dist_utilities_bundle_js__WEBPACK_IMPORTED_MODULE_2__["default"].convertToNumeric;
var calculateLoanPrincipal = _core_dist_core_bundle_js__WEBPACK_IMPORTED_MODULE_1__["default"].calculateLoanPrincipal,
  cmhcPremiumCalculator = _core_dist_core_bundle_js__WEBPACK_IMPORTED_MODULE_1__["default"].cmhcPremiumCalculator,
  calculatePeriodicInterest = _core_dist_core_bundle_js__WEBPACK_IMPORTED_MODULE_1__["default"].calculatePeriodicInterest,
  calculateTotalNumberOfPayments = _core_dist_core_bundle_js__WEBPACK_IMPORTED_MODULE_1__["default"].calculateTotalNumberOfPayments,
  calculateMortage = _core_dist_core_bundle_js__WEBPACK_IMPORTED_MODULE_1__["default"].calculateMortage;
...
// GET
app.get('/hello', /*#__PURE__*/function () {
...
app.get('/loadClientScript', /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2(req, res) {
    var jsScriptPath;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          jsScriptPath = path__WEBPACK_IMPORTED_MODULE_3__.join(__dirname, 'dist', 'client.bundle.js');
          return _context2.abrupt("return", res.status(200).sendFile(jsScriptPath));
        case 2:
        case "end":
...
// POST
app.post('/calculateMortgage', /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee3(req, res) {
    var body, propertyPrice, downPayment, annualInterestRate, paymentSchedule, ammortizationPeriod, cleanPropertPrice, cleanDownpayment, cleanAnnualInterestRate, cleanAmmortizationPeriod, _calculateLoanPrincip, loanPrincipal, downpaymentRate, calculatedCmhcPremium, usePrincipal, _calculatePeriodicInt, periodicInterestRate, totalNumberOfPayments, computedPaymentPerSchedule, respoonse;
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          ...
          _calculateLoanPrincip = calculateLoanPrincipal(cleanPropertPrice, cleanDownpayment), loanPrincipal = _calculateLoanPrincip.loanPrincipal, downpaymentRate = _calculateLoanPrincip.downpaymentRate;
          calculatedCmhcPremium = cmhcPremiumCalculator(loanPrincipal, downpaymentRate);
          usePrincipal = calculatedCmhcPremium ? calculatedCmhcPremium.principalWithPremium : loanPrincipal;
          _calculatePeriodicInt = calculatePeriodicInterest(cleanAnnualInterestRate, paymentSchedule), periodicInterestRate = _calculatePeriodicInt.periodicInterestRate;
          totalNumberOfPayments = calculateTotalNumberOfPayments(cleanAmmortizationPeriod, paymentSchedule);
          computedPaymentPerSchedule = calculateMortage(usePrincipal, periodicInterestRate, totalNumberOfPayments);
          respoonse = {
          ...
          return _context3.abrupt("return", res.status(200).json(respoonse));
        case 14:
        case "end":
...
var __webpack_exports__expressApp = __webpack_exports__.expressApp;
var __webpack_exports__expressServer = __webpack_exports__.expressServer;
export { __webpack_exports__expressApp as expressApp, __webpack_exports__expressServer as expressServer };
