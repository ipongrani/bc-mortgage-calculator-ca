...
/* harmony export */   "default": () => (/* binding */ calculateRates)
/* harmony export */ });
/* harmony import */ var _core_dist_core_bundle_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../core/dist/core.bundle.js */ "../core/dist/core.bundle.js");

var calculateLoanPrincipal = _core_dist_core_bundle_js__WEBPACK_IMPORTED_MODULE_0__["default"].calculateLoanPrincipal,
  cmhcPremiumCalculator = _core_dist_core_bundle_js__WEBPACK_IMPORTED_MODULE_0__["default"].cmhcPremiumCalculator,
  calculatePeriodicInterest = _core_dist_core_bundle_js__WEBPACK_IMPORTED_MODULE_0__["default"].calculatePeriodicInterest,
  calculateTotalNumberOfPayments = _core_dist_core_bundle_js__WEBPACK_IMPORTED_MODULE_0__["default"].calculateTotalNumberOfPayments,
  calculateMortage = _core_dist_core_bundle_js__WEBPACK_IMPORTED_MODULE_0__["default"].calculateMortage;
function calculateRates(paymentSchedule, cleanPropertPrice, cleanDownpayment, cleanAnnualInterestRate, cleanAmmortizationPeriod) {
  var _calculateLoanPrincip = calculateLoanPrincipal(cleanPropertPrice, cleanDownpayment),
    loanPrincipal = _calculateLoanPrincip.loanPrincipal,
    downpaymentRate = _calculateLoanPrincip.downpaymentRate;
  var calculatedCmhcPremium = cmhcPremiumCalculator(loanPrincipal, downpaymentRate);
  var usePrincipal = calculatedCmhcPremium ? calculatedCmhcPremium.principalWithPremium : loanPrincipal;
  var _calculatePeriodicInt = calculatePeriodicInterest(cleanAnnualInterestRate, paymentSchedule),
    periodicInterestRate = _calculatePeriodicInt.periodicInterestRate;
  var totalNumberOfPayments = calculateTotalNumberOfPayments(cleanAmmortizationPeriod, paymentSchedule);
  var computedPaymentPerSchedule = calculateMortage(usePrincipal, periodicInterestRate, totalNumberOfPayments);
  var response = {
...
/* harmony import */ var _utils_dist_utilities_bundle_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../utils/dist/utilities.bundle.js */ "../utils/dist/utilities.bundle.js");
/* harmony import */ var path__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! path */ "path");
/* harmony import */ var url__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! url */ "url");
/* harmony import */ var _src_calculateRates_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./src/calculateRates.js */ "./src/calculateRates.js");
  ...
  var _ref2 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2(req, res) {
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          jsScriptPath = path__WEBPACK_IMPORTED_MODULE_2__.join(__dirname, 'dist', 'client.bundle.js');
...
app.post('/calculateMortgage', /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee3(req, res) {
    var body, propertyPrice, downPayment, annualInterestRate, paymentSchedule, ammortizationPeriod, cleanPropertPrice, cleanDownpayment, cleanAnnualInterestRate, cleanAmmortizationPeriod, response;
